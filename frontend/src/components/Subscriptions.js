...
const Subscriptions = () => {
    ...
    useEffect(() => {
        // Fetch subscription posts when the component mounts
        const fetchSubscriptionPosts = async () => {
            try {
                ...
                setSubscriptionPosts(response.data.posts);
            } catch (error) {
                console.error('Error fetching subscription posts:', error.message || error);
            }
        };
    ...
    useEffect(() => {
        subscriptionPosts.forEach((post) => {
    ...
    return (
        <div className="container text-center mt-5">
            <h2 className="mb-4">Subscription Posts</h2>
            <div className="row">
